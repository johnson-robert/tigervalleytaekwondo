...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2018 at 05:46 AM
...
(13, 'rob', 'johnson', 'onemonsta@hotmail.com', '$2y$10$ldG.vePztRJvKb2NOtdzIOgUNlXm1tnMLiYUfQQD.jpBrQFg2wpse', '1', ''),
(14, 'marlena', 'johnson', 'marlenajohnson@bluehost.org', '1Silverado!', '3', '');
...
(47, 'Enterprise', 'Space Ship', '/acme/image/no-image.png', '/acme/image/no-image.png', '99999999.99', 1, 32767, 32767, 'Space Dock 4', 241, 'Federation', 'Metal White'),
(53, 'Cane', 'white striped', '/acme/image/no-image.png', '/acme/image/no-image.png', '200000.00', 2, 6, 8, 'North Pole', 246, 'Santa', 'hook');
...
--
ALTER TABLE `categories`
  MODIFY `categoryId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=247;
